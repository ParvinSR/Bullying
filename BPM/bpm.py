...
if __name__ == "__main__":
    data_path = "/content/drive/MyDrive/BPM"
    train_df = pd.read_csv(os.path.join(data_path,"train.txt"),sep='\t',header=None, names=['similarity','p1'])
    dev_df = pd.read_csv(os.path.join(data_path,"dev.txt"),sep='\t',header=None, names=['similarity','p1'])
    test_df = pd.read_csv(os.path.join(data_path,"test.txt"),sep='\t',header=None, names=['similarity','p1'])
    target_dir = "/content/drive/MyDrive/BPM"
