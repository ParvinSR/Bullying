...
# %cd /content/drive/MyDrive/BPM_LC_FC_RC
...
class DataPrecessForSentence(Dataset):
    ...
    def get_input(self, df):
        sentences = df['p1'].values + str(df['p2']) + str(df['p3']) + str(df['p4'])
...
if __name__ == "__main__":
    data_path = "/content/drive/MyDrive/BPM_LC_FC_RC"
    train_df = pd.read_csv(os.path.join(data_path,"train.txt"),sep='\t',header=None, names=['similarity','p1', str('p2'), str('p3'), str('p4')])
    dev_df = pd.read_csv(os.path.join(data_path,"dev.txt"),sep='\t',header=None, names=['similarity','p1', str('p2'), str('p3'), str('p4')])
    test_df = pd.read_csv(os.path.join(data_path,"test.txt"),sep='\t',header=None, names=['similarity','p1', str('p2'), str('p3'), str('p4')])
    target_dir = "/content/drive/MyDrive/BPM_LC_FC_RC"
